...
//go:linkname GetRegexFromPattern github.com/i2y/ramune/internal/tsgo/vfs.GetRegexFromPattern
func GetRegexFromPattern(pattern string, useCaseSensitiveFileNames bool) *regexp2.Regexp

//go:linkname GetSubPatternFromSpec github.com/i2y/ramune/internal/tsgo/vfs.GetSubPatternFromSpec
func GetSubPatternFromSpec(spec string, basePath string, usage vfs.Usage, matcher vfs.WildcardMatcher) string

//go:linkname IsImplicitGlob github.com/i2y/ramune/internal/tsgo/vfs.IsImplicitGlob
func IsImplicitGlob(lastPathComponent string) bool

//go:linkname ReadDirectory github.com/i2y/ramune/internal/tsgo/vfs.ReadDirectory
