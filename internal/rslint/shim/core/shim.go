...
//go:linkname ApplyBulkEdits github.com/i2y/ramune/internal/tsgo/core.ApplyBulkEdits
func ApplyBulkEdits(text string, edits []core.TextChange) string

//go:linkname BoolToTristate github.com/i2y/ramune/internal/tsgo/core.BoolToTristate
...
//go:linkname CompareBooleans github.com/i2y/ramune/internal/tsgo/core.CompareBooleans
func CompareBooleans(a bool, b bool) int

//go:linkname CompareTextRanges github.com/i2y/ramune/internal/tsgo/core.CompareTextRanges
func CompareTextRanges(r1 core.TextRange, r2 core.TextRange) int

type CompilerOptions = core.CompilerOptions

//go:linkname ComputeECMALineStarts github.com/i2y/ramune/internal/tsgo/core.ComputeECMALineStarts
func ComputeECMALineStarts(text string) core.ECMALineStarts

//go:linkname ComputeECMALineStartsSeq github.com/i2y/ramune/internal/tsgo/core.ComputeECMALineStartsSeq
...
//go:linkname GetNewLineKind github.com/i2y/ramune/internal/tsgo/core.GetNewLineKind
func GetNewLineKind(s string) core.NewLineKind

//go:linkname GetRequestID github.com/i2y/ramune/internal/tsgo/core.GetRequestID
func GetRequestID(ctx context.Context) string

//go:linkname GetScriptKindFromFileName github.com/i2y/ramune/internal/tsgo/core.GetScriptKindFromFileName
func GetScriptKindFromFileName(fileName string) core.ScriptKind

//go:linkname IndexAfter github.com/i2y/ramune/internal/tsgo/core.IndexAfter
...
//go:linkname NewTextRange github.com/i2y/ramune/internal/tsgo/core.NewTextRange
func NewTextRange(pos int, end int) core.TextRange

//go:linkname NewThrottleGroup github.com/i2y/ramune/internal/tsgo/core.NewThrottleGroup
func NewThrottleGroup(ctx context.Context, semaphore chan struct{}) *core.ThrottleGroup

//go:linkname NewWorkGroup github.com/i2y/ramune/internal/tsgo/core.NewWorkGroup
func NewWorkGroup(singleThreaded bool) core.WorkGroup

var NodeCoreModules = core.NodeCoreModules

//go:linkname NonRelativeModuleNameForTypingCache github.com/i2y/ramune/internal/tsgo/core.NonRelativeModuleNameForTypingCache
...
//go:linkname PositionToLineAndByteOffset github.com/i2y/ramune/internal/tsgo/core.PositionToLineAndByteOffset
...
//go:linkname ResolveConfigFileNameOfProjectReference github.com/i2y/ramune/internal/tsgo/core.ResolveConfigFileNameOfProjectReference
func ResolveConfigFileNameOfProjectReference(path string) string

//go:linkname ResolveProjectReferencePath github.com/i2y/ramune/internal/tsgo/core.ResolveProjectReferencePath
...
//go:linkname ShouldRewriteModuleSpecifier github.com/i2y/ramune/internal/tsgo/core.ShouldRewriteModuleSpecifier
...
//go:linkname StringifyJson github.com/i2y/ramune/internal/tsgo/core.StringifyJson
...
//go:linkname TryParsePattern github.com/i2y/ramune/internal/tsgo/core.TryParsePattern
func TryParsePattern(pattern string) core.Pattern

type TypeAcquisition = core.TypeAcquisition

//go:linkname UTF16Len github.com/i2y/ramune/internal/tsgo/core.UTF16Len
func UTF16Len(s string) core.UTF16Offset

type UTF16Offset = core.UTF16Offset

//go:linkname UndefinedTextRange github.com/i2y/ramune/internal/tsgo/core.UndefinedTextRange
func UndefinedTextRange() core.TextRange

var UnprefixedNodeCoreModules = core.UnprefixedNodeCoreModules

//go:linkname Version github.com/i2y/ramune/internal/tsgo/core.Version
func Version() string

//go:linkname VersionMajorMinor github.com/i2y/ramune/internal/tsgo/core.VersionMajorMinor
...
//go:linkname WithRequestID github.com/i2y/ramune/internal/tsgo/core.WithRequestID
