...
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker"
...
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/jsnum"
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/nodebuilder"
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/printer"
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/scanner"
import "github.com/i2y/ramune/internal/rslint/tsgo_pinned/tracing"
import "sync"
import "unsafe"
...
//go:linkname Checker_getResolvedSignature github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getResolvedSignature
...
//go:linkname Checker_getTypeOfSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getTypeOfSymbol
func Checker_getTypeOfSymbol(recv *checker.Checker, symbol *ast.Symbol) *checker.Type
//go:linkname Checker_getWidenedType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getWidenedType
func Checker_getWidenedType(recv *checker.Checker, t *checker.Type) *checker.Type
//go:linkname Checker_getPropertiesOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getPropertiesOfType
func Checker_getPropertiesOfType(recv *checker.Checker, t *checker.Type) []*ast.Symbol
//go:linkname Checker_getPropertyOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getPropertyOfType
func Checker_getPropertyOfType(recv *checker.Checker, t *checker.Type, name string) *ast.Symbol
//go:linkname Checker_getSignaturesOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getSignaturesOfType
func Checker_getSignaturesOfType(recv *checker.Checker, t *checker.Type, kind checker.SignatureKind) []*checker.Signature
//go:linkname Checker_getIndexInfosOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getIndexInfosOfType
func Checker_getIndexInfosOfType(recv *checker.Checker, t *checker.Type) []*checker.IndexInfo
//go:linkname Checker_getIndexTypeOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getIndexTypeOfType
func Checker_getIndexTypeOfType(recv *checker.Checker, t *checker.Type, keyType *checker.Type) *checker.Type
//go:linkname Checker_getBaseTypes github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getBaseTypes
func Checker_getBaseTypes(recv *checker.Checker, t *checker.Type) []*checker.Type
//go:linkname Checker_getReturnTypeOfSignature github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getReturnTypeOfSignature
func Checker_getReturnTypeOfSignature(recv *checker.Checker, sig *checker.Signature) *checker.Type
//go:linkname Checker_getApparentType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getApparentType
func Checker_getApparentType(recv *checker.Checker, t *checker.Type) *checker.Type
//go:linkname Checker_getTypeArguments github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getTypeArguments
func Checker_getTypeArguments(recv *checker.Checker, t *checker.Type) []*checker.Type
//go:linkname Checker_getTypeFromTypeNode github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getTypeFromTypeNode
func Checker_getTypeFromTypeNode(recv *checker.Checker, node *ast.Node) *checker.Type
//go:linkname Checker_isArrayType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).isArrayType
func Checker_isArrayType(recv *checker.Checker, t *checker.Type) bool
//go:linkname Checker_isArrayOrTupleType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).isArrayOrTupleType
func Checker_isArrayOrTupleType(recv *checker.Checker, t *checker.Type) bool
//go:linkname Checker_getDeclaredTypeOfSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getDeclaredTypeOfSymbol
func Checker_getDeclaredTypeOfSymbol(recv *checker.Checker, symbol *ast.Symbol) *checker.Type
//go:linkname Checker_getBaseTypeOfLiteralType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getBaseTypeOfLiteralType
func Checker_getBaseTypeOfLiteralType(recv *checker.Checker, t *checker.Type) *checker.Type
//go:linkname Checker_getBaseConstraintOfType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getBaseConstraintOfType
func Checker_getBaseConstraintOfType(recv *checker.Checker, t *checker.Type) *checker.Type
//go:linkname Checker_getContextualType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getContextualType
func Checker_getContextualType(recv *checker.Checker, node *ast.Node, contextFlags checker.ContextFlags) *checker.Type
//go:linkname Checker_getContextualTypeForArgumentAtIndex github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getContextualTypeForArgumentAtIndex
func Checker_getContextualTypeForArgumentAtIndex(recv *checker.Checker, callTarget *ast.Node, argIndex int) *checker.Type
//go:linkname Checker_getAwaitedType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getAwaitedType
func Checker_getAwaitedType(recv *checker.Checker, t *checker.Type) *checker.Type
//go:linkname Checker_getAccessedPropertyName github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getAccessedPropertyName
func Checker_getAccessedPropertyName(recv *checker.Checker, access *ast.Node) (string, bool)
//go:linkname Checker_getPropertyNameForKnownSymbolName github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).getPropertyNameForKnownSymbolName
func Checker_getPropertyNameForKnownSymbolName(recv *checker.Checker, symbolName string) string
//go:linkname Checker_isTypeAssignableTo github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).isTypeAssignableTo
func Checker_isTypeAssignableTo(recv *checker.Checker, source *checker.Type, target *checker.Type) bool
//go:linkname Checker_isTypeStrictSubtypeOf github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.(*Checker).isTypeStrictSubtypeOf
...
//go:linkname CompareTypes github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.CompareTypes
...
//go:linkname CreateModeMismatchDetails github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.CreateModeMismatchDetails
func CreateModeMismatchDetails(program checker.Program, file *ast.SourceFile) checker.DiagnosticDetails
//go:linkname CreateModuleNotFoundChain github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.CreateModuleNotFoundChain
...
//go:linkname FormatTypeFlags github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.FormatTypeFlags
func FormatTypeFlags(flags checker.TypeFlags) []string
type FunctionTypeMapper = checker.FunctionTypeMapper
//go:linkname GetDeclarationModifierFlagsFromSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.GetDeclarationModifierFlagsFromSymbol
func GetDeclarationModifierFlagsFromSymbol(s *ast.Symbol) ast.ModifierFlags
//go:linkname GetPropertyNameFromType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.GetPropertyNameFromType
func GetPropertyNameFromType(t *checker.Type) string
//go:linkname GetResolvedSignatureForSignatureHelp github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.GetResolvedSignatureForSignatureHelp
...
//go:linkname GetSetAccessorValueParameter github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.GetSetAccessorValueParameter
func GetSetAccessorValueParameter(accessor *ast.Node) *ast.Node
//go:linkname GetSingleVariableOfVariableStatement github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.GetSingleVariableOfVariableStatement
...
//go:linkname IsExternalModuleSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsExternalModuleSymbol
func IsExternalModuleSymbol(moduleSymbol *ast.Symbol) bool
//go:linkname IsInTypeQuery github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsInTypeQuery
func IsInTypeQuery(node *ast.Node) bool
//go:linkname IsKnownSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsKnownSymbol
func IsKnownSymbol(symbol *ast.Symbol) bool
//go:linkname IsPrivateIdentifierSymbol github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsPrivateIdentifierSymbol
func IsPrivateIdentifierSymbol(symbol *ast.Symbol) bool
//go:linkname IsTupleType github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsTupleType
func IsTupleType(t *checker.Type) bool
//go:linkname IsTypeAny github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsTypeAny
func IsTypeAny(t *checker.Type) bool
//go:linkname IsTypeUsableAsPropertyName github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.IsTypeUsableAsPropertyName
...
//go:linkname NewChecker github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewChecker
func NewChecker(program checker.Program, tracer *checker.Tracer) (*checker.Checker, *sync.Mutex)
//go:linkname NewDiagnosticChainForNode github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewDiagnosticChainForNode
func NewDiagnosticChainForNode(chain *ast.Diagnostic, node *ast.Node, message *diagnostics.Message, args ...any) *ast.Diagnostic
//go:linkname NewDiagnosticForNode github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewDiagnosticForNode
func NewDiagnosticForNode(node *ast.Node, message *diagnostics.Message, args ...any) *ast.Diagnostic
//go:linkname NewNodeBuilder github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewNodeBuilder
func NewNodeBuilder(ch *checker.Checker, e *printer.EmitContext) *checker.NodeBuilder
//go:linkname NewNodeBuilderEx github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewNodeBuilderEx
...
//go:linkname NewSymbolTrackerImpl github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewSymbolTrackerImpl
func NewSymbolTrackerImpl(context *checker.NodeBuilderContext, tracker nodebuilder.SymbolTracker) *checker.SymbolTrackerImpl
//go:linkname NewTracer github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.NewTracer
...
//go:linkname SkipAlias github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.SkipAlias
...
//go:linkname TryGetModuleSpecifierFromDeclaration github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.TryGetModuleSpecifierFromDeclaration
...
//go:linkname ValueToString github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.ValueToString
...
//go:linkname IsNonDeferredTypeReference github.com/i2y/ramune/internal/rslint/tsgo_pinned/checker.isNonDeferredTypeReference
