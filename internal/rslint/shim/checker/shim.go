...
import "github.com/i2y/ramune/internal/tsgo/checker"
...
import "github.com/i2y/ramune/internal/tsgo/evaluator"
import "github.com/i2y/ramune/internal/tsgo/jsnum"
import "github.com/i2y/ramune/internal/tsgo/nodebuilder"
import "github.com/i2y/ramune/internal/tsgo/printer"
import "sync"
import "unsafe"
...
//go:linkname Checker_getResolvedSignature github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getResolvedSignature
...
//go:linkname Checker_getTypeOfSymbol github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getTypeOfSymbol
func Checker_getTypeOfSymbol(recv *checker.Checker, symbol *ast.Symbol) *checker.Type

//go:linkname Checker_getWidenedType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getWidenedType
func Checker_getWidenedType(recv *checker.Checker, t *checker.Type) *checker.Type

//go:linkname Checker_getPropertiesOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getPropertiesOfType
func Checker_getPropertiesOfType(recv *checker.Checker, t *checker.Type) []*ast.Symbol

//go:linkname Checker_getPropertyOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getPropertyOfType
func Checker_getPropertyOfType(recv *checker.Checker, t *checker.Type, name string) *ast.Symbol

//go:linkname Checker_getSignaturesOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getSignaturesOfType
func Checker_getSignaturesOfType(recv *checker.Checker, t *checker.Type, kind checker.SignatureKind) []*checker.Signature

//go:linkname Checker_getIndexInfosOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getIndexInfosOfType
func Checker_getIndexInfosOfType(recv *checker.Checker, t *checker.Type) []*checker.IndexInfo

//go:linkname Checker_getIndexTypeOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getIndexTypeOfType
func Checker_getIndexTypeOfType(recv *checker.Checker, t *checker.Type, keyType *checker.Type) *checker.Type

//go:linkname Checker_getBaseTypes github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getBaseTypes
func Checker_getBaseTypes(recv *checker.Checker, t *checker.Type) []*checker.Type

//go:linkname Checker_getReturnTypeOfSignature github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getReturnTypeOfSignature
func Checker_getReturnTypeOfSignature(recv *checker.Checker, sig *checker.Signature) *checker.Type

//go:linkname Checker_getApparentType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getApparentType
func Checker_getApparentType(recv *checker.Checker, t *checker.Type) *checker.Type

//go:linkname Checker_getTypeArguments github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getTypeArguments
func Checker_getTypeArguments(recv *checker.Checker, t *checker.Type) []*checker.Type

//go:linkname Checker_getTypeFromTypeNode github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getTypeFromTypeNode
func Checker_getTypeFromTypeNode(recv *checker.Checker, node *ast.Node) *checker.Type

//go:linkname Checker_isArrayType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).isArrayType
func Checker_isArrayType(recv *checker.Checker, t *checker.Type) bool

//go:linkname Checker_isArrayOrTupleType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).isArrayOrTupleType
func Checker_isArrayOrTupleType(recv *checker.Checker, t *checker.Type) bool

//go:linkname Checker_getDeclaredTypeOfSymbol github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getDeclaredTypeOfSymbol
func Checker_getDeclaredTypeOfSymbol(recv *checker.Checker, symbol *ast.Symbol) *checker.Type

//go:linkname Checker_getBaseTypeOfLiteralType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getBaseTypeOfLiteralType
func Checker_getBaseTypeOfLiteralType(recv *checker.Checker, t *checker.Type) *checker.Type

//go:linkname Checker_getBaseConstraintOfType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getBaseConstraintOfType
func Checker_getBaseConstraintOfType(recv *checker.Checker, t *checker.Type) *checker.Type

//go:linkname Checker_getContextualType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getContextualType
func Checker_getContextualType(recv *checker.Checker, node *ast.Node, contextFlags checker.ContextFlags) *checker.Type

//go:linkname Checker_getContextualTypeForArgumentAtIndex github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getContextualTypeForArgumentAtIndex
func Checker_getContextualTypeForArgumentAtIndex(recv *checker.Checker, callTarget *ast.Node, argIndex int) *checker.Type

//go:linkname Checker_getAwaitedType github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getAwaitedType
func Checker_getAwaitedType(recv *checker.Checker, t *checker.Type) *checker.Type

//go:linkname Checker_getAccessedPropertyName github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getAccessedPropertyName
func Checker_getAccessedPropertyName(recv *checker.Checker, access *ast.Node) (string, bool)

//go:linkname Checker_getPropertyNameForKnownSymbolName github.com/i2y/ramune/internal/tsgo/checker.(*Checker).getPropertyNameForKnownSymbolName
func Checker_getPropertyNameForKnownSymbolName(recv *checker.Checker, symbolName string) string

//go:linkname Checker_isTypeAssignableTo github.com/i2y/ramune/internal/tsgo/checker.(*Checker).isTypeAssignableTo
func Checker_isTypeAssignableTo(recv *checker.Checker, source *checker.Type, target *checker.Type) bool

//go:linkname Checker_isTypeStrictSubtypeOf github.com/i2y/ramune/internal/tsgo/checker.(*Checker).isTypeStrictSubtypeOf
...
//go:linkname CompareTypes github.com/i2y/ramune/internal/tsgo/checker.CompareTypes
...
//go:linkname GetDeclarationModifierFlagsFromSymbol github.com/i2y/ramune/internal/tsgo/checker.GetDeclarationModifierFlagsFromSymbol
func GetDeclarationModifierFlagsFromSymbol(s *ast.Symbol) ast.ModifierFlags

//go:linkname GetResolvedSignatureForSignatureHelp github.com/i2y/ramune/internal/tsgo/checker.GetResolvedSignatureForSignatureHelp
...
//go:linkname GetSingleVariableOfVariableStatement github.com/i2y/ramune/internal/tsgo/checker.GetSingleVariableOfVariableStatement
...
//go:linkname IsExternalModuleSymbol github.com/i2y/ramune/internal/tsgo/checker.IsExternalModuleSymbol
func IsExternalModuleSymbol(moduleSymbol *ast.Symbol) bool

//go:linkname IsInTypeQuery github.com/i2y/ramune/internal/tsgo/checker.IsInTypeQuery
func IsInTypeQuery(node *ast.Node) bool

//go:linkname IsKnownSymbol github.com/i2y/ramune/internal/tsgo/checker.IsKnownSymbol
func IsKnownSymbol(symbol *ast.Symbol) bool

//go:linkname IsPrivateIdentifierSymbol github.com/i2y/ramune/internal/tsgo/checker.IsPrivateIdentifierSymbol
func IsPrivateIdentifierSymbol(symbol *ast.Symbol) bool

//go:linkname IsTupleType github.com/i2y/ramune/internal/tsgo/checker.IsTupleType
func IsTupleType(t *checker.Type) bool

//go:linkname IsTypeAny github.com/i2y/ramune/internal/tsgo/checker.IsTypeAny
...
//go:linkname NewChecker github.com/i2y/ramune/internal/tsgo/checker.NewChecker
func NewChecker(program checker.Program) (*checker.Checker, *sync.Mutex)

//go:linkname NewDiagnosticChainForNode github.com/i2y/ramune/internal/tsgo/checker.NewDiagnosticChainForNode
func NewDiagnosticChainForNode(chain *ast.Diagnostic, node *ast.Node, message *diagnostics.Message, args ...any) *ast.Diagnostic

//go:linkname NewDiagnosticForNode github.com/i2y/ramune/internal/tsgo/checker.NewDiagnosticForNode
func NewDiagnosticForNode(node *ast.Node, message *diagnostics.Message, args ...any) *ast.Diagnostic

//go:linkname NewNodeBuilder github.com/i2y/ramune/internal/tsgo/checker.NewNodeBuilder
func NewNodeBuilder(ch *checker.Checker, e *printer.EmitContext) *checker.NodeBuilder

//go:linkname NewNodeBuilderEx github.com/i2y/ramune/internal/tsgo/checker.NewNodeBuilderEx
...
//go:linkname NewSymbolTrackerImpl github.com/i2y/ramune/internal/tsgo/checker.NewSymbolTrackerImpl
...
//go:linkname SkipAlias github.com/i2y/ramune/internal/tsgo/checker.SkipAlias
...
//go:linkname TryGetModuleSpecifierFromDeclaration github.com/i2y/ramune/internal/tsgo/checker.TryGetModuleSpecifierFromDeclaration
...
//go:linkname ValueToString github.com/i2y/ramune/internal/tsgo/checker.ValueToString
...
//go:linkname IsNonDeferredTypeReference github.com/i2y/ramune/internal/tsgo/checker.isNonDeferredTypeReference
